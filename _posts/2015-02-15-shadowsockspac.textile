...
另外我在GitHub建了个["代码库(ShadowSocksPac)":https://github.com/foryoung365/ShadowSocksPac]，提供了源代码，基于leaskh的flora_Pac项目修改而成，目前只支持[*ShadowSocks-gui*]，要求2.3以上版本（2.3版本的配置文件格式与之前不同）。["GenPac.exe文件可从这里下载":/attachments/GenPac.exe]，感兴趣的可以自己去下载源代码，欢迎补充完善或者在本站评论区提供建议。这个还是自用为主，不喜勿喷。
